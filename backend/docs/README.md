...
Backend API server for the Bajaj Operations Management mobile application. Powers branch-level operations including user authentication, check management, attendance tracking, appliance monitoring, complaint ticketing, approval workflows, branch visit scheduling, and push notifications.
...
| Checks | `/api/tasks` | Check CRUD, completion, proof submission |
...
| Cron | `/api/cron` | Automated check generation |
...
| Role | ID | Description |
|------|-----|-------------|
| Local Coordinator | `lc` | Branch-level operator, marks checks, attendance, reports issues |
