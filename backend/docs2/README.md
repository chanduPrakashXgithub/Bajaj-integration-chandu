...
2. **Bundling**: Dashboard endpoints bundle multiple related entities into a single HTTP response (e.g., `/lc/dashboard` returns `branch`, `checks`, `complaints`, `appliances`, `todayAttendance` in a single round-trip).
